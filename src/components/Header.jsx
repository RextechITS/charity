...
export default function Header() {
    ...
    return (
        <header className="w-full fixed bg-white text-white flex justify-between items-center z-50">
            {/* top header */}
            <div className="hidden w-[90%] mx-auto bg-[#122f2a] lg:flex items-center justify-between rounded-bl-2xl rounded-br-2xl p-4" >
                ...
                <div className="flex justify-between items-center gap-5">
                    <div className="flex justify-between items-center gap-2">
                        ...
                        <a href="mailto:rextechitsolution@gmail.com?subject=Website%20Inquiry">rextechitsolution@gmail.com</a>
